(function () {	var game = new Phaser.Game(800, 600, Phaser.AUTO, '', { preload: preload, create: create, update: update });
function preload() {		game.load.image('ball', 'assets/sprites/shinyball.png');	}
var balls;
function create()
{
...
function update()
{
    if (game.input.mousePointer.isDown)
    {
        ...
        // 	Third is the parameter/s the callback expects
